...
public class ReminderEmailIntegrationTest {
    ...
    void setUp() {
        ...
        testRequest.setImageUrl("https://images.unsplash.com/photo-1463936575829-25148e1db1b8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2090&q=80");
    ...
    void testSendRealEmail() {
        ...
        // To run it, remove the @Disabled annotation on the class and provide a valid email in application-test.properties
